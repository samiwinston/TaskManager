 ...
 */
public class SearchCountryEditText extends EditText implements IGenericCallBack {


    private ListView mListView;
    private CharSequence mLabelField = "name";
    private SearchableCntryOnlnListAdapter mSimpleAdapter;
    ...
    public SearchCountryEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void initListView(ListView value,List<HashMap<String,Object>> values) {
        ...
        mSimpleAdapter = new SearchableCntryOnlnListAdapter(context);
    ...
    private void refreshList(CharSequence searchText) {
        ServiceModel.getInstance().taskService.getSearchableItems(searchText.toString(),"Country").enqueue(callBack());
    }
