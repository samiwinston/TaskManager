...
public class MobLeaveRequestFormBean implements Parcelable {
    ...
    public String lastCountryOnLeaveName;
    ...
    public MobLeaveRequestFormBean(Bundle b) {
        ...
        this.lastCountryOnLeaveName = b.getString("lastCountryOnLeaveName");
    ...
    public Bundle getBundle() {
        ...
        b.putString("lastCountryOnLeaveName", lastCountryOnLeaveName);
...
/*		dest.writeValue(this.maxAllowedFamilyTickets);
    ...
    public Boolean isAddressInfoFilled() {
        return (lastPhoneOnLeave != null && lastAddressOnLeave != null && lastCountryOnLeave > 0);
    }
